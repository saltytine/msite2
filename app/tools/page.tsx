...
import { ChevronRight, Filter, ArrowDownAZ, Terminal, Shield, AlertTriangle, Search } from "lucide-react"
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <div className="relative w-full md:w-64">
                ...
                <Input placeholder="Search tools..." className="pl-8 bg-malectrica-darker border-malectrica-blue/30" />
              </div>
            </div>
          </div>
